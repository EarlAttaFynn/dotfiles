...
require('lazy').setup({
  ...
  -- Add nvim-web-devicons to your plugins list
  {
...
--  require("telescope").extensions.file_browser.file_browser({ hidden = false, desc = '[F]ile [B]rowser' })
--end)
...
local servers = {
  ...
  yamlls = {
    ...
    --To override a schema to use a specific k8s schema version
    -- schemas = {
